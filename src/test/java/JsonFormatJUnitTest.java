...
public class JsonFormatJUnitTest extends Assertions {
    private static final Logger logger = LoggerFactory.getLogger(JsonFormatJUnitTest.class);
    private static List<String> listOfCommits;
    private static String regex;
    private static Format format;
    private static String requiredResult;

    @BeforeAll
    static void initGitLog() {
        ...
        regex = "(?<commitId>^\\w+)(?<jiraIssue>\\w+\\(.+\\))(?<text>[\\.:]\\s.+)";
    ...
    @Test
    void testJsonFormat() {
        GitCommitsParser parser = new GitCommitsParser("", regex, format, "");
